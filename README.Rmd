...
Or you can install this compendium as an R package, `covid19.forecatss.uk`, from GitHub with:
...
Because data on ICU bed occupancy were not available at the time of writing the manuscript, this data is not included in the package and the corresponding panel in Figure 2 missing if using the command above.
